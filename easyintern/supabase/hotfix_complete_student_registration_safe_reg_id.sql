-- Run in Supabase SQL Editor after payment 409 on complete_student_registration.
-- Fixes students_registration_id_key conflicts and adds safe registration id allocation.
