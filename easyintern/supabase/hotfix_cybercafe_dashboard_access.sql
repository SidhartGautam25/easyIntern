-- Cyber cafe portal: columns, indexes, RLS, and SECURITY DEFINER list RPCs.
-- Run in Supabase SQL Editor when cafe dashboard shows no students (500 on students?cybercafe_email=…).
...
-- Direct SELECT fallback (when RPC not used)
